...
| [ocio-allocation-transform-lg2](src/ocio-allocation-transform-lg2)  | copy of the OCIO AllocationTransform algorithm                             | blink         | ![grading](https://img.shields.io/badge/grading-43896b)     |
